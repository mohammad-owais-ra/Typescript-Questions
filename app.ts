...
let authour : string= "Neil Armstrong"
console.log(`${authour} once said, ${quote}`)



// q5
let Famousperson:string="Prophet S.A.W";
let theQuote:string="The strongest among you is the one who controls his anger";
...
// q6
let thenamewithwhitespace:string= "\n\t  Owais  \n\t"
console.log("The name with white space:",thenamewithwhitespace );

let strippedname:string= thenamewithwhitespace.trim();
...
// q11
let friends : string [] = ['Owais','Talha','Kabeer'];
...
// q12
let names:string[]=["Talha","Owais","Kabeer"];
names .forEach(names =>{
...
// q13
let motorcylebrands:string[]=["Honda","Kawasaki","BMW","Harley Daivison"];
...
// q14
let guests:string[]=["Talha","Kabeer","Zohaib"];
...
// q15
let guest1:string[]=["Zohaib","Talha","Kabeer"];

const cannotattend :string ="Zohaib";
console.log(`${cannotattend} can't make it`);

const newinvitee:string ="Abeer";
const IndexOfCannotAttend: number= guest1.indexOf(cannotattend);
if(IndexOfCannotAttend !== -1){
    guest1[IndexOfCannotAttend]= newinvitee
}
guest1 .forEach((guest :string) =>{
...
// q16
let guest2:string[]=["Ali","Umer","Ahmed"];
...
// q17
let guest3:string[]=["Zeshaan","Ayan","Fahad"];
...
// q18
let places:string[]=["Skardu","Islamabad","Karachi","Peshawar"];
...
// q19
let dinnerguests:string[]= [" Ahsan" , " Ali" , " Bilal"];
console.log(`You Are  Invited on Dinner${dinnerguests} . Thankyou`);

// q20
let Fruits:string[]=["Watermelon","Pomegranate","Apple","Orange"];
...
// q21
let cars : { brands:string , models:string , yearof: number , color:string }[]=[
...
// q22
let myArray :number[]=[1,2,3,5,6,7,8,9,10];
...
let alien0_color: string = 'yellow';
...
// q26
let alien1_color: string = 'yellow'; // You can change this to 'green', 'yellow', or 'red'
...
// q28
let age: number = 30; // You can change the age value to test different scenarios
...
// q31
let users :string[]=["Ahmed","Ali","Ayan"];
if (users.length ===0) {
...
let new_users: string[] = ["Alice", "Eve", "Charlie", "David", "Frank"];
...
// q34
let favouritepizzas :string[]=["Fajita","B.Bq","tikka"];
...
function make_the(magicians: string[]): string[] {
...
const modifiedMagicians: string[] = make_the(magicianNames.slice());
